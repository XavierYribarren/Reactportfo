          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className='navbar-text'>
                <div className='social-icon'>
                    <a href="https://www.linkedin.com/in/xavier-yribarren-9a8777173/"><img src={navIcon1} className="ln-logo" alt=""/></a>
                   <a href="https://github.com/Xaboule"><img src={navIcon2} className="gh-logo" alt=""/></a>
