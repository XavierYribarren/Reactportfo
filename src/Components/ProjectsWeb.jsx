...
const nopeText = { title: `2nd School Project`,
                    content : 
 `  We had to create a  React App 
 and fetch some 
...
const emergaText = { title: `3rd School Project`,
content : "We worked on a webApp for EmerGa, a life-saving app allowing faster interventions and more precise information on an incident. We had to make both Frontend and Backend parts",
technos : 'HTML, CSS, JavaScript, React, Express, MySQL'}
const narifText = { title: `N.A.R.I.F`,
content : "Pretending there's a Native American Roulette Federation, it's basically a Russian Roulette with a bow. It was a fun exercise to show that something absurd with a serious shape could still work!",
  ...
  return (
    <group  ref={tabModel} {...props} dispose={null} rotation={props.rotation} position={props.position}>
     ...
     onPointerOver={() => setHovered(true)} onPointerOut={() => setHovered(false)}
        ...
        material-emissive={hovered ? '' : props.texture}
      > 
      <group scale={0.1} >
...
narifTex.flipY = false
  ...
  <group>
    ...
    >
      <Model texture={nopeTex} text={nopeText} rotation={[0,-Math.PI * 1.1,0]} position={[-0.042,0,-0.02]}/>
      <Model texture={emergaTex} text={emergaText} rotation={[0,-Math.PI*1.3,0]} position={[-0.22,0,-0.14]}/>
      <Model texture={narifTex} text={narifText} rotation={[0,-Math.PI*1.45,0]} position={[-0.3,0,-0.32]}/>
    </mesh>
  </group>
  </>
  )
